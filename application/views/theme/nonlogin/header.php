...
<html lang="en">
  <head>
    ...
    <!-- Animate.css -->
    <link href="<?php echo base_url() ;?>gentelella-master/vendors/animate.css/animate.min.css" rel="stylesheet">
	...
	<script src="<?php echo base_url()?>js/jquery_validate/jquery.validate.min.js"></script>
	</head>
